This project is a clone of the Amazon website, created using HTML and CSS. The primary goal of this project is to practice and demonstrate proficiency in front-end web development.
<br><br>
Project Overview<br>
